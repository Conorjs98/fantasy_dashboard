        ...
        <div className="min-w-[620px]">
          <div className="grid grid-cols-[48px_1fr_100px_80px_80px_80px] gap-2 px-4 py-2.5 border-b border-[#222] rounded-t">
            ...
            <span className="text-[9px] uppercase tracking-widest text-text-secondary text-right flex items-center justify-end gap-1">
              PWR
              <span
                className="group relative inline-flex cursor-help rounded-full border border-text-secondary/50 w-3.5 h-3.5 items-center justify-center text-[8px] text-text-secondary hover:text-accent hover:border-accent"
